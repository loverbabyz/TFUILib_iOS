...
//! Project version number for TFUILib.
FOUNDATION_EXPORT double TFUILibVersionNumber;

//! Project version string for TFUILib.
FOUNDATION_EXPORT const unsigned char TFUILibVersionString[];
