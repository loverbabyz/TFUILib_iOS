...
@interface TFMJRefreshGifHeader()
{
...
@implementation TFMJRefreshGifHeader
#pragma mark - 懒加载
- (UIImageView *)gifView
{
    if (!_gifView) { 
...
- (void)placeSubviews
{
    ...
    if (self.stateLabel.hidden && self.lastUpdatedTimeLabel.hidden) {
        ...
        self.gifView.tf_mj_w = self.tf_mj_w * 0.5 - textWidth * 0.5 - self.labelLeftInset;
    }
}
