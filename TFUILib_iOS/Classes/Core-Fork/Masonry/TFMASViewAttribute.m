...
@implementation TFMASViewAttribute
...
- (BOOL)isEqual:(TFMASViewAttribute *)viewAttribute {
...
- (NSUInteger)hash {
    return TF_MAS_NSUINTROTATE([self.view hash], TF_MAS_NSUINT_BIT / 2) ^ self.layoutAttribute;
}
